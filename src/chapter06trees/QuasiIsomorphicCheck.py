...
def quasiIsomorphic(root1, root2):
    ...
    if (not root1 and root2) or (root1 and not root2):
        return 0
    return (
        quasiIsomorphic(root1.left, root2.left)
        and quasiIsomorphic(root1.right, root2.right)
        or quasiIsomorphic(root1.right, root2.left)
        and quasiIsomorphic(root1.left, root2.right)
    )
